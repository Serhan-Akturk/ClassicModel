...
#top 3 locations where there are max employees
#SELECT * FROM employees;
SELECT city, COUNT(*) as "Office location" 
...
#We need to add remote employee
INSERT INTO employees (employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle)
VALUES (7567,"Worker", "Remote" ,"x3643", "remotework@gmail.com",0,1143,"Sales Rep");

#Added an office that had remote capabilities. The officeCode is 0.
...
#employees with no offices, and offices with no employees.
INSERT INTO offices (officeCode,phone,addressLine1,addressLine2,state,postalCode,territory,city,country)
...
#Show top 2 employees by total sales booked.
...
#Show top 3 product lines amount
...
#show customers who have never purchased any item and are just in our DB by location
